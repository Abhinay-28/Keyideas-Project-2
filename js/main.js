(function setupHeroAnimation() {
  ...
  requestAnimationFrame(() => {
    ...
    function showContent(type, event) {
      document.getElementById("content-box").innerHTML = contentData[type];
